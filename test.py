# Test.py is for documentation purposes only. The Final file is named pradak.py
    ...
    def show_activity_types(self):
        tutorial_steps = [
            {
                ...
                "description": "Activity Types describe what kind of work happens at each cost center. Examples: 'CNC Machining Hours', 'Manual Assembly Time', 'Quality Inspection Hours'."
            },
            {
                "title": "Step 1: Create Activity Types",
                "description": "First, create your custom activity types using the form on the left. Enter a name like 'CNC Machining Hours' and description. This builds your library of activities."
            },
            {
        ...
        info = tk.Label(info_card, justify="left", bg=self.colors["white"], fg=self.colors["text_secondary"],
                        text=("Step 1: First, create custom activity types below.\n"
                              ...
                              "Examples: 'CNC Machine Hours', 'Assembly Labor', 'Quality Control'"))
    ...
    def show_planned_cost(self):
        tutorial_steps = [
            ...
            },
            {
                ...
                "description": "Enter an Order ID (like 'PO-2024-001') and Product Name. These identify your production order."
            },
            {
                "title": "Adding Cost Elements",
                "description": "For each order, add cost elements like 'CNC Machining', 'Raw Materials', etc. Enter planned quantity and rate per unit/hour."
            },
            {
                "title": "Planning Tips",
